...
int main() {
    ...
    cout << "\nWelcome to the Skip List Playlist - let's get started!" << endl;
    ...
    while (!done) {
        ...
        cout << "\nEnter the number for the operation you would like to perform (7 to view menu, Q to quit): ";
        cin >> selection;

        if (cin.fail()) {done = true;} // exit program for any non-int selection

        else if (selection == 1) { // upload file
            cout << "\nEnter the file name you would like to upload - must be a tab delimited text file (txt): ";
            string file_name;
            ...
            cout << "\nLet's get the info for the song you want to add to the library." << endl;
            string artist_name;
            string song_name;
            ...
            cout << "\nLet's get the info for the song you want to remove from the library" << endl;
            string artist_name;
            string song_name;
            song_input(artist_name, song_name);
            string formatted_song = playlist.song_format(artist_name, song_name);
            ...
            cout << "\nLet's get the info for the song you want to search for in your library" << endl;
            string artist_name;
            string song_name;
            song_input(artist_name, song_name);
            string formatted_song = playlist.song_format(artist_name, song_name);
            ...
            cout << "\nHow many songs do you want to be in the playlist? ";
            int playlist_length;
            cin >> playlist_length;
